        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <h1 class="hello" >Hello from the PokarPetr developer laravel repository</h1><br><br>
                        <h1 class="hello" >Travel Distances from TGD (Podgorica) to Airports in Europe</h1><br>
                        <div >
                            @foreach ($airport_mod as $airport)
                                <div class="airport-list">
                                    ...
                                    <span>&ndash; &gt;</span>
                                    <span>{{ $airport->distance_in_meters }}</span>
                                </div>
                            @endforeach
                        </div>
                        <br><br>
