...
class AirportsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $airports = [
            ...
            ['airport_code' => 'VIE', 'airport_name' => 'Vienna International Airport', 'city' => 'Vienna', 'coordinates' => DB::raw("ST_PointFromText('POINT(48.21 16.400)', 4326)")],
            ['airport_code' => 'BUD', 'airport_name' => 'Budapest Ferenc Liszt International Airport', 'city' => 'Budapest', 'coordinates' => DB::raw("ST_PointFromText('POINT(46.467 4.183)', 4326)")],
            ['airport_code' => 'OTP', 'airport_name' => 'Henri Coanda International Airport', 'city' => 'Bucharest', 'coordinates' => DB::raw("ST_PointFromText('POINT(44.5711 26.0850)', 4326)")],
            ...
            ['airport_code' => 'LJU', 'airport_name' => 'Ljubljana Joze Pucnik Airport', 'city' => 'Ljubljana', 'coordinates' => DB::raw("ST_PointFromText('POINT(46.2233 14.4589)', 4326)")],
            ...
            ['airport_code' => 'PRG', 'airport_name' => 'Vaclav Havel Airport', 'city' => 'Prague', 'coordinates' => DB::raw("ST_PointFromText('POINT(50.1008 14.27044)', 4326)")],
